export function Divulgar() {
  return (
    <form action="#" className="p-6 bg-gray-100 rounded-lg">
      ...
      <input
        type="text"
        className="block bg-gray-50 border border-gray-300 text-sm rounded-lg focus:border-blue-500 w-full p-2.5 mb-2"
      />
      ...
      <div className="flex gap-4">
        <div className="flex-grow">
          ...
          <input
            type="text"
            className="block bg-gray-50 border border-gray-300 text-sm rounded-lg focus:border-blue-500 w-full p-2.5"
          />
        </div>
        <div className="flex-grow">
          <label htmlFor="name" className="block mb-2 text-sm font-medium">
